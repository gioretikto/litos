...
void set_acels (struct lit *litos)
{
	...
	const GActionEntry app_entries[] = {
		...
		{"italic", insertHtmlTags, "s", NULL, NULL, {0,0,0}},
		{"bold", insertHtmlTags, "s", NULL, NULL, {0,0,0}},
		{"h2", insertHtmlTags, "s", NULL, NULL, {0,0,0}},
		{"h3", insertHtmlTags, "s", NULL, NULL, {0,0,0}},
		{"a", insertHtmlTags, "s", NULL, NULL, {0,0,0}},
		{"p", insertHtmlTags, "s", NULL, NULL, {0,0,0}},
		{"sup", insertHtmlTags, "s", NULL, NULL, {0,0,0}},
		{"sub", insertHtmlTags, "s", NULL, NULL, {0,0,0}},
		{"minus", insertChar, "s", NULL, NULL, {0,0,0}},
		{"div", insertChar, "s", NULL, NULL, {0,0,0}},
		{"arrow", insertChar, "s", NULL, NULL, {0,0,0}},
		{"arrow_left", insertChar, "s", NULL, NULL, {0,0,0}},
		{"dot", insertChar, "s", NULL, NULL, {0,0,0}},
		{"list", insertChar, "s", NULL, NULL, {0,0,0}},
		{"bond", insertChar, "s", NULL, NULL, {0,0,0}},
		{"space", insertChar, "s", NULL, NULL, {0,0,0}},
	...
	struct {
	  ...
	  { "app.bold(\"<b>%s</b>\")", { "<Control>b", NULL} },
	  { "app.italic(\"<i>%s</i>\")", { "<Control>i", NULL} },
	  { "app.h2(\"<h2>%s</h2>\")", { "<Control>2", NULL} },
	  { "app.h3(\"<h3>%s</h3>\")", { "<Control>3", NULL} },
	  { "app.a('<a href=\"this.html\">%s</a>')", { "<Control>h", NULL} },
	  { "app.p(\"<p>%s</p>\")", { "<Control>p", NULL} },
	  { "app.sup(\"<sup>%s</sup>\")", { "<Control><Shift>p", NULL} },
	  { "app.sub(\"<sub>%s</sub>\")", { "<Control>u", NULL} },
	  { "app.div('<div class=\"eq\">\n<p>this</p>\n</div>\')", { "<Control>g", NULL} },
	  { "app.minus(\"−\")", { "<Control>m", NULL} },
	  { "app.dot(\"⋅\")", { "<Control>d", NULL} },
	  { "app.list(\"</li>\")", { "<Control>l", NULL} },
	  { "app.arrow(\"⟶⟼⇒\")", { "<Control>t", NULL} },
	  { "app.bond", { "<Shift><Control>l", NULL} },
	  { "app.arrow_left(\"⇌⟵⇐\")", { "<Control>y", NULL} },
	  { "app.space(\"&emsp;■□\")", { "<Control>e", NULL} },
